	...
	return (
		<>
			<Tabs defaultValue="account" className="w-full">
				<TabsList className=" flex flex-row w-2/5 mx-auto content-center">
					<TabsTrigger value="about-us">Tentang Kami</TabsTrigger>
					<TabsTrigger value="company-policy">Kebijakan Perusahaan</TabsTrigger>
				</TabsList>
				...
				<div>
					...
					<TabsContent value="about-us">
						<section
							id="about-us"
							className="container mx-auto px-4 py-12 mb-2"
						>
							<Card>
								<CardHeader>
								...
								<CardContent>
									<p className="text-lg text-justify">
										...
										memberdayakan komunitas pertanian dengan alat dan sumber
										daya yang mereka butuhkan untuk berkembang. Misi kami adalah
										menjembatani kesenjangan antara petani dan konsumen dengan
										memberikan produk yang berkualitas tinggi dan mempromosikan
							...
							<Card>
								...
								<CardContent>
									<p className="text-lg text-justify">
										...
										keberlanjutan dan tanggung jawab sosial. Kami percaya bahwa
										pertanian berkelanjutan adalah kunci untuk masa depan yang
										lebih baik dan bahwa setiap keputusan bisnis harus
										mempertimbangkan dampaknya terhadap masyarakat dan
										lingkungan.
										<br />
										<br />
							...
							<Card>
								...
								<CardContent>
									...
									<p className="text-lg text-justify mt-6">
										...
										mencerminkan dedikasi kami terhadap kualitas dan
										keberlanjutan. Sertifikasi dan penghargaan yang kami terima
										adalah bukti komitmen kami untuk selalu memberikan yang
