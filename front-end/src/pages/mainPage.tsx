    ...
    <div>
      ...
      >
        <div className="text-center px-4 md:px-8">
          <h1 className="text-base md:text-4xl font-bold text-black mb-2 -mt-2">
            Produk Terbaik, Terpercaya, Langsung dari Petani Lokal!
          </h1>
          <div className="mt-4">
            <button className="bg-black text-white px-4 py-2 rounded mr-2 mb-20 md:mb-4 hover:shadow-lg transition-shadow duration-300">
              Promo
            </button>
            <button className="bg-gray-300 px-4 py-2 rounded mb-40 md:mb-4 hover:shadow-lg transition-shadow duration-300">
              Produk Baru
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              <img
                ...
                className="w-full rounded"
              />
              <h3 className="mt-4 text-sm md:text-lg font-semibold">Sayuran</h3>
            </Link>
            <Link
              to="/product/buah"
              className="text-center relative hover:shadow-lg transition-shadow duration-300"
            >
              <img
                ...
                className="w-full rounded"
              />
              <h3 className="mt-4 text-sm md:text-lg font-semibold">Buah</h3>
            </Link>
            <Link
              to="/productpage3"
              className="text-center relative hover:shadow-lg transition-shadow duration-300"
      ...
      <div className="container mx-auto p-4 md:p-8">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-xl md:text-2xl font-bold">Penawaran Hari Ini</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div className="bg-white p-4 rounded shadow">
            <img
              src="../images/apel-malang.jpg"
              alt="Apel Malang"
              className="w-full h-24 md:h-32 object-cover rounded"
            />
            <h3 className="mt-4 text-sm md:text-lg font-semibold">Diskon 7%</h3>
            <p className="text-gray-600">Rp 14.300</p>
            <p className="text-gray-400 text-xs md:text-sm">Apel Malang</p>
          </div>
          <div className="bg-white p-4 rounded shadow">
            <img
            ...
            <p className="text-gray-400 text-xs md:text-sm">Daging Ayam</p>
          </div>
          <div className="bg-white p-4 rounded shadow">
            <img
            ...
            <p className="text-gray-400 text-xs md:text-sm">Nanas Pemalang</p>
          </div>
          <div className="bg-white p-4 rounded shadow">
            <img
            ...
            <p className="text-gray-400 text-xs md:text-sm">Kacang Mede</p>
          </div>
        </div>
      </div>
      {/* Main Content */}
      <div className="container mx-auto p-4 md:p-8">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-xl md:text-2xl font-bold">Paling Laris</h1>
          <a href="#" className="text-blue-500">
            View All
          </a>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div className="bg-white p-4 rounded shadow">
            <img
              ...
              className="w-full h-24 md:h-32 object-cover mb-4"
            />
            <div className="text-sm md:text-lg font-semibold">Rp 13.000</div>
          ...
          <div className="bg-white p-4 rounded shadow">
            <img
              ...
              className="w-full h-24 md:h-32 object-cover mb-4"
            />
            <div className="text-sm md:text-lg font-semibold">Rp 12.000</div>
          ...
          <div className="bg-white p-4 rounded shadow">
            <img
              ...
              className="w-full h-24 md:h-32 object-cover mb-4"
            />
            <div className="text-sm md:text-lg font-semibold">Rp 10.500</div>
          ...
          <div className="bg-white p-4 rounded shadow">
            <img
              ...
              className="w-full h-24 md:h-32 object-cover mb-4"
            />
            <div className="text-sm md:text-lg font-semibold">Rp 25.000</div>
          ...
          <div className="bg-white p-4 rounded shadow">
            <img
              ...
              className="w-full h-24 md:h-32 object-cover mb-4"
            />
            <div className="text-sm md:text-lg font-semibold">Rp 10.000</div>
